      ...
      <div className="product_details">
        ...
        <div className="product_rating d-flex align-items-center gap-5 mb-3">
          <div>
            ...
            <motion.span whileTap={{scale: 1.2}} onClick={()=> setRating(2)}><i class="ri-star-s-fill"></i></motion.span>
            <motion.span whileTap={{scale: 1.2}} onClick={()=> setRating(3)}><i class="ri-star-s-fill"></i></motion.span>
            <motion.span whileTap={{scale: 1.2}} onClick={()=> setRating(4)}><i class="ri-star-s-fill"></i></motion.span>
            <motion.span whileTap={{scale: 1.2}} onClick={()=> setRating(5)}><i class="ri-star-s-fill"></i></motion.span>
          </div>
          <p>
                ...
                <div className="review__form">
                  ...
                  <form action="" onSubmit={submitHandler}>
                    <div className="form__group">
                      <input type="text" placeholder='Enter name' ref={reviewUser} req/>
                    </div>
