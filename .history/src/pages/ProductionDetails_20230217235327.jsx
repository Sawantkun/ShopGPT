     ...
     <Row>
      ...
      <div className="product_details">
        ...
        <div className="product_rating d-flex align-items-center gap-5 mb-3">
          <div>
            <motion.span onClick={()=> setRating(1)}><i class="ri-star-s-fill"></i></motion.span>
            <motion.span whileTap={{scale: 1.2}} onClick={()=> setRating(2)}><i class="ri-star-s-fill"></i></motion.span>
            <motion.span onClick={()=> setRating(3)}><i class="ri-star-s-fill"></i></motion.span>
            <motion.span onClick={()=> setRating(4)}><i class="ri-star-s-fill"></i></motion.span>
            <motion.span onClick={()=> setRating(5)}><i class="ri-star-s-fill"></i></motion.span>
          </div>
          <p>
